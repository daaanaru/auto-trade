...
- **30万円ペーパートレード稼働中（3/13リセット、3/15データ修復済み）**: 5市場対応、4/12期限。**決済25件（実現損益-2,634円、勝率72.0%=18W7L）**。損切5件すべてが日本株ショート（QDレーザに2度焼かれ-3,838円）。仮想通貨ロングは決済8件+1,205円と好調。3/16にSLキャップ-5%・TP1 3.0x改善済み、3/23レビュー。**3/20に米国株4銘柄(JPM/AAPL/XOM/META)が7日強制決済到達**
